...
def word_detail(request, word_id):
    ...
    sentences = [
        ...
        for index, sentence_id, sentence_value in word.sentenceword_set.values_list('index', 'sentence__id', 'sentence__value')
    ]
    print(sentences)
    context = {
        "word": word,
...
def sentence_detail(request, sentence_id):
    ...
    words = [
        ...
        for index, word_id, word_name in sentence.sentenceword_set.values_list('index', 'word__id', 'word__name')
    ]
    context = {
        "sentence": sentence,
        "words": words
